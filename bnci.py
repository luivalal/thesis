...
MY_URL = "https://zenodo.org/record/7949879/files/"
...
def load_data(
    ...
    dataset_list = {
        ...
        "MY_DATA": _load_my_data,  ## EDIT HERE
    }
...
def _load_my_data(
    ...
    """Load data for KEIO LUIS BCI EXPERIMENTS"""
    ...
    for r in ["T", "E"]:
        ...
        filename = data_path(url, path, force_update, update_path)  ##  THIS LINE DOWNLOADS FROM INTERNET
